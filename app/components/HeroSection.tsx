  ...
  return (
    <div className="relative text-center py-24 px-6 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-2xl shadow-lg">
      <div className="max-w-3xl mx-auto">
        ...
        <Button className="mt-6 px-6 py-3 text-lg font-semibold bg-black text-blue-600 rounded-full shadow-md transition duration-300 hover:bg-blue-100 hover:scale-105">
          Explore Ads
        </Button>
      </div>
    </div>
